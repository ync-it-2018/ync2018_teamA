			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="/front/FloginPost" method="post">
							<div class="contact-form wthree">
								<div class="" style="padding-left:150px; padding-right:150px; text-align:center">
									<input type="text" name="ID" placeholder="아이디">
								</div>
								<div class="" style="text-align:center">
									<input class="text" type="password" name="PASSWD" style="height:45px; width:285px; padding-left:10px"
										placeholder="비밀번호" style="">
								</div>
								<br>
								<input type="checkbox" name="useCookie" style="text-align:center"> Remember Me
								<br>
								<input type="submit" value="로그인" style="margin-left: 39%">
							</div>
						</form>
						<br>
