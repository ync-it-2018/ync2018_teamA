...
<body>
						...
						<ul class="slides">
							<li data-thumb="images/se1.jpg">
								<div class="thumb-image">
									<img src="/resources/front/images/images/se1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="images/se2.jpg">
								<div class="thumb-image">
									<img src="/resources/front/images/images/se2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="images/se3.jpg">
								<div class="thumb-image">
									<img src="/resources/front/images/images/se3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
		...
		<div class="container">
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="/resources/front/images/mages/pay2.png" alt="">
						</li>
						<li>
	...
	<!-- imagezoom -->
	<script src="/resources/front/images/js/imagezoom.js"></script>
	<!-- //imagezoom -->

	<!-- FlexSlider -->
	<script src="/resources/front/images/js/jquery.flexslider.js"></script>
	<script>
