		...
		<div class="col-md-12">
			...
			<div class='box'>
				<div class="box-header with-border">
					<h3 class="box-title">Purchase Search</h3>
				</div>
				<div class='box-body'>
					...
					<table class="table table-bordered">
						...
						<c:forEach items="${list}" var="purchaseVO">
							<tr>
								...
								<td><a
									href='/admin/purchase/purchasedetail?code=${purchaseVO.ORDER_CODE}'>${purchaseVO.PRODUCT_NAME}</a></td>
