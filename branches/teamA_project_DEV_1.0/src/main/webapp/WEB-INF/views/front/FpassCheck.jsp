...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">정보 수정 전 비밀 번호 확인
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="#" method="post">
							<p style="color:black" align="center">홍길동님의 정보를 안전하게 보호하기 위하여</p>
							<p style="color:red" align="center">비밀번호를 다시 한번 확인합니다.</p>
							<table>
								<tr>
									<th class="passCheck_object">아이디</th>
									<td class="passCheck_content">ync12345</td>
								</tr>
								<tr>
									<th class="passCheck_object">비밀번호</th>
									<td class="passCheck_content"><input type="password"></td>
								</tr>
								
							</table>
							</br>
							<input type="submit" value="취소" class="passCheck_button">
							<input type="submit" value="확인" class="passCheck_button">
						</form>
					</div>
