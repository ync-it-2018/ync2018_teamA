...
<body>
					...
					<div class="resp-tabs-container hor_1">
						...
						<div>
							<div id="tab4" class="tab-grid" style="display: block;">
								<div class="row">
									<div class="col-md-6">
										<img class="pp-img" src="/resources/front/images/images/paypal.png" alt="Image Alternative text" title="Image Title">
	...
	<script src="/resources/front/images/js/easyResponsiveTabs.js"></script>
	...
	<!-- credit-card -->
	<script src="/resources/front/images/js/creditly.js"></script>
