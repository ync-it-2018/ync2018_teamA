...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".btn-primary").on("click", function() {
			self.location = "/admin/purchase/refundlist";
		});
	});
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<table class="table table-bordered">
							...
							<tr>
								<th>결제수단</th>
								<td colspan="1">${purchaseVO.ORDER_MEANS}</td>
								<th>처리현황</th>
								<c:choose>
									<c:when test="${02 eq purchaseVO.STATUS}">
										<td colspan="2" style="color: red">환불요청</td>
									</c:when>
									<c:otherwise>
										<td colspan="2" style="color: blue">환불완료</td>
									</c:otherwise>
								</c:choose>
							</tr>
