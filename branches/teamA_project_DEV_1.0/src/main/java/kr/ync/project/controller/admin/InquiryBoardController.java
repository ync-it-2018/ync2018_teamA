...
public class InquiryBoardController {
	...
	public String NoticeBoardRegisterGET(InquiryBoardVO board, Model model) throws Exception {
	...
	public String NoticeBoardRegisterPOST(RedirectAttributes rttr, SearchCriteria cri, InquiryBoardVO board, Model model) throws Exception {
	...
	public String NoticeBoardModifyPOST(SearchCriteria cri, InquiryBoardVO board, RedirectAttributes rttr) throws Exception {
