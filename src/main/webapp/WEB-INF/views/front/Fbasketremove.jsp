...
<head>
	...
	<style>
      ...
      .passCheck_button_submit {
      	position: relative;
      	left: 310px;
      }
      
      .passCheck_button_cancel {
      	position: relative;
      	left: 280px;
      }
	</style>
...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">장바구니 상품 삭제
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="#" method="post">
							<p align="center" style="color:orange; font-size:30px; font-weight:bold">상품 삭제</p>
							<p style="color:black" align="center">선택하신 상품을 장바구니 페이지에서 정말로 삭제하시겠습니까?</p>
							</br>
							
							<p style="color:red" align="center">삭제된 상품은 패키지를 검색하여 다시 찾아 볼 수 있으며 장바구니로 넣으실 수 있습니다.</p>
							
							</br>
							<input type="submit" value="취소" class="passCheck_button_cancel">
							<input type="submit" value="삭제" class="passCheck_button_submit">
						</form>
					</div>
