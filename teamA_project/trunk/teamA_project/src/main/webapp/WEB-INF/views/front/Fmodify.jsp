				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="#" method="post">
							<table>
								<tr>
									<th class="table_object">이름</th>
									<td class="table_content">홍길동</td>
								<tr>
								<tr>
									<th class="table_object">아이디</th>
									<td class="table_content">ync12345</td>
								<tr>
								<tr>
									<th class="table_object">비밀번호</th>
									<td class="table_password"><input type="password" placeholder="비밀번호" style="margin-bottom:3px; margin-top:3px; padding-left: 10px;">
									&emsp;&emsp;&emsp;&emsp;&emsp;
									<input type="password" placeholder="비밀번호 확인" style="padding-left: 10px;"></td>
								<tr>
								<tr>
									<th class="table_object">E-mail</th>
									<td class="table_blank"><input type="text" placeholder="E-mail 주소" style="height: 5px; width: 300px; margin-bottom:3px; margin-top:3px;"></td>
								<tr>
								<tr>
									<th class="table_object">휴대폰번호</th>
									<td class="table_blank"><input type="text" placeholder="(-)없이 입력" style="height: 5px; width: 300px; margin-bottom:3px; margin-top:3px;"></td>
								<tr>
								<tr>
									<th class="table_object">생년월일</th>
									<td class="table_blank"><input type="text" placeholder="(-)포함해서 입력" style="height: 5px; width: 330px; margin-bottom:3px; margin-top:3px;"></td>
								<tr>
							</table>
							<input type="submit" value="수정한 정보 저장" class="modify_button">
						</form>
					</div>
